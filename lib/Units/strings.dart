class strings {
  //This All strings for The Intro Screen
  static String nowScan = "Now, Scan Any OR";
  static String payUse = "to pay using Paytm";
  ...
  static String buyInsurance = "Buy Insurance";
  static String travel = "Travel & Flights";
  static String onlineShopping = "Online Shopping";
  static String showMore = "Show More";
  static String miniPrograms = "Mini Program";
  static String dominos = "Domino's";
  ...
  static String cashbackMsg =
      "Stickers, Reward Points, Cashback Vouchers & Offers";
  static String orderBooking = "Orders & Bookings";
  ...
  static String askToScan = "Ask to Scan this QR to Accept Money";
  static String shareOR = "Share QR";
  static String acceptPayment = "Accept Payments";
  static String paymentSetting = "Payment Settings";
  static String paymentSettingMsg = "Saved, Automatic & other payment details";
  static String securitySetting = "Security Setting";
  static String securitySettingMsg = "App Lock,Password & Privacy";
  static String notificationSetting = "Notification Settings";
  static String paymentReminders = "Payment Reminders";
  static String saveAddress = "Saved Address";
